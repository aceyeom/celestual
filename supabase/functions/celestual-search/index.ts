// CELESTUAL — celestual-search edge function (Instagram @ typeahead).
//
...
// front-end's searchHandles() adapter (app/src/api/celestual.js) calls this
...
//
// Deploy:  supabase functions deploy celestual-search
