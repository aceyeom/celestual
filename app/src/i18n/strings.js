...
const en = {
  ...
  // ── the recruitment program (migration 0016) ────────────────────────────
  // Someone comments "celestual" under the reel, gets a dm, signs here, and
  // walks away with a link that counts what they bring in.
  'recruit.kicker': 'the program',
  'recruit.loading': 'opening…',
  'recruit.title1': 'bring',
  'recruit.title2': 'your people.',
  'recruit.rule1': 'you get one link. everyone who joins celestual through it is counted as yours.',
  'recruit.rule2': 'post it where it belongs. your story, your close friends, your group chat.',
  'recruit.rule3': 'never buy followers, never spam, never run ads with it. that ends the deal.',
  'recruit.rule4': 'never claim celestual shows who likes you. it doesn’t, and saying so gets your link pulled.',
  'recruit.rule5': 'we count opens and signups. we never see who anyone pinged, and neither do you.',
  'recruit.signLabel': 'type your full name to sign',
  'recruit.signPlaceholder': 'your name',
  'recruit.sign': 'sign it',
  'recruit.signing': 'signing…',
  'recruit.signNote': 'signing records your name, your @ and the date.',
  'recruit.errName': 'we need your full name to record the signature.',
  'recruit.errLink': 'that link has lapsed. comment celestual again for a fresh one.',
  'recruit.liveTitle': 'your link is live.',
  'recruit.linkLabel': 'your link',
  'recruit.share': 'share it',
  'recruit.copied': 'copied',
  'recruit.statVisits': 'opens',
  'recruit.statSignups': 'joined',
  'recruit.week': 'the last seven days',
  'recruit.keepNote': 'keep this page. it’s the only way back to your numbers on this device.',
  'recruit.toApp': 'go to celestual',
  'recruit.deadTitle': 'this link has lapsed.',
  'recruit.deadBody': 'comment celestual under the reel again and we’ll send a fresh one.',
  'recruit.deadCta': 'go to celestual',
