...
//   · 25–45 words. About a third carry no seal, so a seal reads as something
//     somebody chose rather than a field the form demanded.
//
// `h` recipient handle · `b` the letter · `s` the seal, or null
...
export const SEED = [
  ...
  { h: 'sofiaaa.reyes', b: "Different person, same table. You explained the reading to somebody who had clearly not done it and you did it without once making them feel stupid. That is a rarer skill than the reading.", s: null },
  { h: 'wren.p', b: "You were the only one who stayed to stack the chairs after the meeting, every week, for a year, while the rest of us were already out of the door and talking about dinner.", s: 'You did the back row first. Always the back row.' },
  { h: 'june.hh', b: "I have started three letters to you and deleted all of them. This is the fourth and I am going to leave it. You were kind to me on a day I had not earned it.", s: null },
  { h: 'omar.dabbagh', b: "Soda, second floor, and you talked me out of dropping out at one in the morning using nothing but a whiteboard and about nine minutes. I finished. I never said why.", s: 'You drew a very bad graph.' },
  { h: 'maren.lindqvist', b: "You brought soup to a floor meeting because one of us had been sick and you did not announce it or make it a thing. It was just there. There was a lid and a ladle.", s: null },
  { h: 'ezra.k.lin', b: "Berkeley Marina in February, and you said the thing about how the fog is not weather, it is the bay breathing. I have repeated that to every person I have ever taken there.", s: 'You were wearing the wrong coat for it.' },
  { h: 'ines.baptista.v', b: "You waited outside the exam hall for a friend who was still inside, for an hour, in the rain, so that they would not walk out to nobody. I was two doors down and I saw all of it.", s: null },
  { h: 'kwame.osei.b', b: "You laughed at my terrible joke in section — the only person who did — and then defended it afterwards on the way out, to somebody who had told me it was terrible.", s: 'It was about the Peloponnesian War. It was terrible.' },
  { h: 'saoirse.nolan.k', b: "You gave a whole tutorial to somebody in the Moffitt stairwell on how to use the printers, patiently, twice, when you were obviously late for something yourself.", s: null },
  { h: 'yuki.matsuda.r', b: "Every Sunday you put the kitchen back the way you found it, including the parts that were not yours, and never once mentioned it to any of us. I noticed in week three.", s: 'You lined the mugs up by handle.' },
  { h: 'tomas.aguirre.n', b: "You told me the truth about the thing I had written when everyone else was being polite about it, and you were right, and I rewrote it, and it got in.", s: null },
  { h: 'delphine.roux.b', b: "Zellerbach, the interval, and you gave your programme to somebody who did not have one and then sat through the whole second half without knowing what was being played.", s: 'You said you would rather be surprised.' },
  { h: 'hassan.el.tayeb', b: "You changed a stranger's bike tyre outside Kroeber and would not take the five dollars they tried to give you, and then you were late, and you did not say you were late.", s: null },
  { h: 'nkechi.obiora.a', b: "I sat behind you in a lecture for a whole semester and never spoke to you, and I still think about the way you asked questions like the answer mattered more than looking clever.", s: 'You always put your hand up last.' },
  { h: 'anders.vikstrom', b: "You spent forty minutes helping me find a book in Doe that turned out to be on the wrong floor entirely, and when we found it you seemed genuinely pleased about it.", s: null },
  { h: 'marisol.quintero', b: "Sproul in the middle of something loud, and you stopped to help somebody pick their whole bag up off the ground while everybody else went round. I went round. I am sorry I went round.", s: 'A hundred flyers, all face down.' },
  { h: 'sinead.oflaherty', b: "You wrote to somebody on this wall. I know because you told me you were going to and then went quiet about whether you had. I hope they looked. I hope it was mutual.", s: null },
  { h: 'raj.balasubramanian', b: "You made a room of very tired people laugh at eleven at night in the middle of a project that was going badly, and everything after that went better, and nobody ever said so.", s: 'You did the voice. You know the voice.' },
  { h: 'oona.mccarthy.b', b: "You brought your own mug to the coffee place every single day for four years and never once made anybody else feel bad about not doing it. That is the whole thing I admired.", s: null },
  { h: 'jonah.osterman', b: "You said something on the steps about how being homesick is just love with nowhere to put itself. I have given that line to four people since. I am giving it back to you now.", s: 'You did not think it was any good.' },
  { h: 'amara.diallo.k', b: "You noticed the new person standing at the edge of the room and you went and stood with them instead of waiting for them to come in. I have watched you do that three times.", s: null },
  { h: 'felix.nakamura.b', b: "You returned a wallet to the desk at Doe with everything still in it and did not leave a name, and I only know it was you because I was in the queue behind you.", s: 'You were annoyed it took so long.' },
  { h: 'zainab.hakimi', b: "You explained the same thing to me four times without ever once letting on that it was the fourth. I got it on the fourth. I have tried to be that person for other people.", s: null },
  { h: 'lars.henriksen.j', b: "Crossroads, the end of a long night, and you carried three trays that were not yours because the person carrying them was clearly about to drop all of them.", s: 'You dropped one. It was fine.' },
  { h: 'aiko.shimizu.p', b: "You left a plant with me over the summer and told me it was hard to kill, which was a kind lie, and I did kill it, and you said nothing about it in September.", s: null },
  { h: 'oskar.bielinski', b: "You lent your only good jacket to somebody going to an interview and wore something useless for a week in February and never mentioned where the jacket was.", s: 'They got the job.' },
  { h: 'thandiwe.mokoena', b: "You told me you liked something I made before I had told anybody I made it, which means you went looking, which is the part I have never got over.", s: null },
  { h: 'emil.rasmussen.c', b: "Evans, the lift that is always broken, and you took the stairs with somebody's boxes for them to the seventh floor and then went back down for the second load.", s: 'You counted the flights out loud.' },
  { h: 'gemma.oyelaran.t', b: "You read a whole draft of something for me in one night and gave it back covered in questions, none of which were unkind, all of which were the right question.", s: null },
  { h: 'petra.kovacevic', b: "You held a seat at a full table for somebody who was fifteen minutes late and got looks about it from three people and held it anyway. I was one of the three. I was wrong.", s: 'You put your bag on it and did not blink.' },
  { h: 'malik.johansson.b', b: "You waited at the bottom of the hill for the slowest person in the group on every single walk, and you did it in a way that never made it look like waiting.", s: null },
  { h: 'freya.osullivan', b: "You told a very long story badly and completely committed to it, and the whole table was better for it, and I have thought about that as a way of being in the world.", s: 'It was about a heron. It went nowhere.' },
]
...
// ── the ledger ──────────────────────────────────────────────────────────────
// What the core service looks like once somebody is standing in it. This is
// the continuation the wall hands off into, so it is populated the same way
// the wall is: two pings standing, one about to lapse, one already mutual.
//
...
export const LEDGER = [
  ...
  { id: 'p-standing', handle: 'ezra.k.lin',   state: 'standing', days: 52, placed: 'eight days ago',
    yours: "I keep the receipt from Cheese Board. Not because of the pizza." },
...
// The seven days the core screen's date strip runs over. Fixed rather than
// derived from the clock: a prototype that reads differently on a Sunday is a
// prototype somebody has to apologise for mid-demo.
